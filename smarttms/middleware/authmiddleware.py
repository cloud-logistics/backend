...
PERMISSION_GROUP_HASH = 'smart_tms_permissions_group_hash'
PERMISSION_URL_HASH = 'smart_tms_permissions_url_hash'
...
class AuthMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        if request.path.startswith(r'/container/api/v1/cloudbox/smarttms/'):  # 检测如果不是登录的话
            try:
                ...
                if token:
                    ...
                    if request.path.startswith(r'/container/api/v1/cloudbox/smarttms/upload/'):
