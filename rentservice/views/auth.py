...
from rentservice.models import RentServiceRegUser, AuthUserGroup, AccessGroup
...
def add_user(request):
    ...
    try:
        ...
        log.error(repr(e))
    ret['enterprise_id'] = new_user.reg_user_id
...
def auth(request):
    ...
    try:
        user = RentServiceRegUser.objects.get(user_name=username, user_password=password)
    except RentServiceRegUser.DoesNotExist:
        log.error(repr(e))
    ...
    except AuthUserGroup.DoesNotExist:
        log.error(repr(e))
